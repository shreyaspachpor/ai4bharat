            ...
            <div className="lg:col-span-4 border-r border-dark-300 px-5 py-4" style={{ background: "#2a2a2a" }}>
              ...
              <form onSubmit={handleSubmit} className="mt-5">
                ...
                <button
                  ...
                  className="w-full mt-3 rounded-xl bg-[#242424] border border-dark-300 py-3 font-semibold text-light-100 hover:border-light-400/40 transition flex items-center justify-center gap-2"
                >
                  <MessageCircle className="h-4 w-4" />
                  Send interview link on WhatsApp
                </button>

                <p className="text-center text-xs text-light-500 mt-2">Opens WhatsApp with pre-filled message</p>
                ...
                {deepLink && (
                  <div className="mt-3 rounded-xl border border-dark-300 bg-[#1f1f1f] px-3 py-2 flex items-center gap-2">
                    ...
                    <button
                      type="button"
                      onClick={copyLink}
                      className="p-1.5 rounded hover:bg-dark-300/40"
                      title="Copy"
                    >
